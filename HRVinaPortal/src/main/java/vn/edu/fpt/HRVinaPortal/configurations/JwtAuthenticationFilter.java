...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1. Kiểm tra xem có header Authorization và có dạng "Bearer " không
        ...
        // 3. Giải mã token để lấy userEmail
        userEmail = jwtService.extractUsername(jwt);

        // 4. Kiểm tra xem userEmail có tồn tại và người dùng chưa được xác thực không
